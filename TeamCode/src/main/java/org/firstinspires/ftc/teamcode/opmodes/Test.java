...
@Autonomous
public class Test extends AutonomousTemplate { // TODO uncomment actual cycle code AFTER this gets tested
    protected TrajectorySequence deliverPreload;
    protected Trajectory intake;
    protected Trajectory delivery;
    ...
    public void initializeTrajectories() {
        ...
        deliverPreload = drive.trajectorySequenceBuilder(startPose()) // TODO is this 72-based or 70-based?
                ...
                .build();
        intake = drive.trajectoryBuilder(deliverPreload.end()) // TODO what is the equivalent of set reversed for plain trajectories? also the point of this is to turn all trajsequences into normal trajs so we can check for continuity issues
                // Intake
